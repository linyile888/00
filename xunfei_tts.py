...
APPID = '7c01410a'  # 替换为你的APPID
APIKEY = '3e5cbe4b6f755b6027bc580db1fda160'  # 替换为你的APIKey
APISECRET = 'YzI2MjcyMDg1NTQ1YjE3MTVjNDYxZTBh'  # 替换为你的APISecret
...
class Ws_Param(object):
    def __init__(self, APPID, APIKey, APISecret, Text):
        ...
        self.BusinessArgs = {
            "tts": {
                "vcn":  "x5_lingfeiyi_flow",# 语音合成模型，可参考 https://www.xfyun.cn/services/smart-tts
                "volume": 50, # 音量
                "rhy": 1, # 韵律
                "speed": 50, # 语速
                "pitch": 50, # 语调
